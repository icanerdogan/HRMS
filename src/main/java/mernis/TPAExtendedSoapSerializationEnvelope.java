...
public class TPAExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(TPADateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new TPAStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static TPADateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static TPADateTimeConverter dateTimeConverter = new TPAStandardDateTimeConverter();

    public TPAExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public TPAExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new TPAMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=TPAHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,TPAExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=TPAHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
