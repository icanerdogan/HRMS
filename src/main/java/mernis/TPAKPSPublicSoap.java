...
public class TPAKPSPublicSoap
{
    ...
    public TPAKPSPublicSoap(){}

    public TPAKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public TPAKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        TPAExtendedSoapSerializationEnvelope envelope= new TPAExtendedSoapSerializationEnvelope(TPAExtendedSoapSerializationEnvelope.VER11);
